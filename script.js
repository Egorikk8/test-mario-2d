...
function draw() {
    ...
    function drawButton(strokeColor, fillColor) {
        ...
        let wightButton = innerWidth * 0.2,
            heightButton = innerHeight * 0.1;
        let xButton = innerWidth * 0.5 - wightButton / 2,
            yButton = innerHeight * 0.5 - heightButton / 2;
        buttonStart.rect(xButton, yButton, wightButton, heightButton);
        ...
        fillButton();
        printText('Start', xButton + wightButton / 2 - 45, yButton + heightButton / 2 + 10, 40, 'Black')
    }
